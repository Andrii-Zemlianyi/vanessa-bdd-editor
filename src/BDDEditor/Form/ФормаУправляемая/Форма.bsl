...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	#Область РежимыИнтерфейса_Простой
	ВосстановитьВыбранныйРежимаИнтерфейса();
	ВосстановитьВыбранныйКаталогFeatureФайлов();
	#КонецОбласти
...
//		Настройки.Свойство("КаталогBDDEditor", Объект.КаталогBDDEditor);
		...
		Настройки.Свойство("НеИспользоватьКаталогFeatures",Объект.НеИспользоватьКаталогFeatures);
...
//	Настройки.Вставить("КаталогBDDEditor", Объект.КаталогBDDEditor);
	...
	Настройки.Вставить("НеИспользоватьКаталогFeatures",Объект.НеИспользоватьКаталогFeatures);
...
Процедура РежимыИнтерфейса_ИспользоватьПрофессиональныйПриИзменении(Элемент)
	СохранитьВыбранныйРежимИнтерфейса();
...
&НаСервере
Процедура ВосстановитьВыбранныйРежимаИнтерфейса() 
	РанееИиспользовалсяПрофессиональный = ХранилищеОбщихНастроек.Загрузить(ЭтаФорма, "РежимыИнтерфейса_ИспользоватьПрофессиональный");
	Если ЗначениеЗаполнено(РанееИиспользовалсяПрофессиональный) Тогда
		РежимыИнтерфейса_ИспользоватьПрофессиональный = РанееИиспользовалсяПрофессиональный;
	КонецЕсли;
КонецПроцедуры

&НаСервере
Процедура ВосстановитьВыбранныйКаталогFeatureФайлов() 
	РанееВыбранныйКаталогFeatureФайлов = ХранилищеОбщихНастроек.Загрузить(ЭтаФорма, "РежимыИнтерфейса_Простой_КаталогFeatureФайлов");
	Если ЗначениеЗаполнено(РанееВыбранныйКаталогFeatureФайлов) Тогда
		РежимыИнтерфейса_Простой_КаталогFeatureФайлов = РанееВыбранныйКаталогFeatureФайлов;
	КонецЕсли;
КонецПроцедуры
...
Процедура РежимыИнтерфейса_Простой_КаталогFeatureФайловОткрытие(Элемент, СтандартнаяОбработка)
	...
	ЗапуститьПриложение(РежимыИнтерфейса_Простой_КаталогFeatureФайлов);
КонецПроцедуры
